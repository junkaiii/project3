...
module.exports = function(apiRoutes) {
    ...
    apiRoutes.get('/', function(req, res) {
      res.json({
        message: 'Welcome to the Jiak Simi Api'
      });
    });
...
apiRoutes.get('/locations', function(req, res) {
  ...
  apiRoutes.get('/locations/:id', function(req, res) {
    ...
    apiRoutes.put('/locations/:id', function(req, res, next) {
    ...
    apiRoutes.delete('/locations/:id', function(req, res, next) {
            Location.findOne({
              "_id": req.params.id
            }).remove(function(err) {
              if (err) return next(err);
